async function generar_reporte_pdf() {
  try {
    ...
    // const response_planes_turisticos = await consultar_planes_turisticoss_reportes();
    // const datos_planes_turisticos    = JSON.parse(response_planes_turisticos);
    // && datos_planes_turisticos.length === 0 // agregar a la condicional
    // Verificar si hay datos
    if (datos_destino.length === 0 && datos_hospedaje.length === 0) {
